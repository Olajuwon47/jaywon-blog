...
export default function Footer() {
    return (
      <footer className="bg-emerald-400  text-black p-4">
        <div className="grid md:grid-cols-4 gap-4">
          <div>
            <input type="checkbox" className="hidden" defaultChecked />
            <h1 className="text-base font-semibold text-black-500 mb-3">Features</h1>
          ...
          <div>
            <input type="checkbox" className="hidden" defaultChecked />
            <h1 className="text-base font-semibold  text-black mb-3">Details</h1>
            <ul className="space-y-1">
          ...
          <div>
            <input type="checkbox" className="hidden" defaultChecked />
            <h1 className="text-base font-semibold  text-black mb-3">FAQ</h1>
            <ul className="space-y-1">
        ...
        <div className="mt-4 flex flex-wrap justify-center space-x-6">
          <a href="https://facebook.com" className="text-gray-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" className="fill-current beatFade" viewBox="0 0 512 512">
          ...
          <a href="https://instagram.com/mrmrs_" className="text-gray-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" className="fill-current beatFade" viewBox="0 0 448 512">
          ...
          <a href="https://youtube.com" className="text-gray-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" className="fill-current beatFade" viewBox="0 0 576 512">
